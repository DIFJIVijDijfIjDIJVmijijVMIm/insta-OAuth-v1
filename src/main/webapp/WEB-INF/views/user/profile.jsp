...
<body>
	...
	<main id="profile">
		...
		<div class="profile__photo-grid">
				...
				<c:forEach var="image" items="${user.image}">
		      <div class="profile__photo">
					<a href="image-detail.html"> <img src="/upload/${image.profile}"></a>
	...
	<div class="profile__overlay">
		...
		<div class="profile__overlay-container">
			<!-- 패스워드 변경 직접 구현 -->
			<a href="/auth/password/${principal.user.id}" class="profile__overlay-link">Change password</a> 
